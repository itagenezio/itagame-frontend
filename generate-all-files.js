...
// API.JS
fs.writeFileSync(path.join(servicesDir, 'api.js'), `import axios from 'axios';
...
// LOGIN.JS
fs.writeFileSync(path.join(srcDir, 'Login.js'), `import React, { useState } from 'react';
...
// REGISTER.JS
fs.writeFileSync(path.join(srcDir, 'Register.js'), `import React, { useState } from 'react';
import api from './services/api';
function Register() {
...
// DASHBOARD.JS
fs.writeFileSync(path.join(srcDir, 'Dashboard.js'), `import React, { useState, useEffect } from 'react';
import api from './services/api';
...
// COURSES.JS
fs.writeFileSync(path.join(srcDir, 'Courses.js'), `import React, { useState, useEffect } from 'react';
import api from './services/api';
function Courses() {
  const [courses, setCourses] = useState([]);
...
// RANKING.JS
fs.writeFileSync(path.join(srcDir, 'Ranking.js'), `import React, { useState, useEffect } from 'react';
import api from './services/api';
function Ranking() {
...
// PROFILE.JS
fs.writeFileSync(path.join(srcDir, 'Profile.js'), `import React, { useState, useEffect } from 'react';
function Profile() {
  const [user, setUser] = useState(null);
  useEffect(() => {
    const userData = JSON.parse(localStorage.getItem('user'));
...
// MISSIONS.JS
fs.writeFileSync(path.join(srcDir, 'Missions.js'), `import React, { useState } from 'react';
function Missions() {
...
// SHOP.JS
fs.writeFileSync(path.join(srcDir, 'Shop.js'), `import React, { useState, useEffect } from 'react';
function Shop() {
  const [user, setUser] = useState(null);
  const [message, setMessage] = useState('');
  const [loading, setLoading] = useState(true);
...
// APP.JS
fs.writeFileSync(path.join(srcDir, 'App.js'), `import React, { useState, useEffect } from 'react';
